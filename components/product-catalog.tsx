...
const allProducts = [
  ...
  },
  {
    ...
    price: 26.99,
    image: "/rose-water-toner-bottle.jpg",
    rating: 4.7,
    reviews: 112,
    category: "toners",
    skinType: ["dry", "sensitive", "all"],
    badge: null,
    description: "Organic rose water toner that hydrates and refreshes skin",
  },
  {
    id: 10,
    name: "Ceramide Repair Cream",
    price: 42.99,
    image: "/ceramide-repair-cream.jpg",
    rating: 4.8,
    reviews: 95,
    category: "moisturizers",
    skinType: ["dry", "mature"],
    badge: "Premium",
    description: "Intensive repair cream with ceramides for damaged skin barrier",
  },
  {
    id: 11,
    name: "Peptide Firming Serum",
    price: 58.99,
    image: "/peptide-firming-serum.jpg",
    rating: 4.9,
    reviews: 67,
    category: "serums",
    skinType: ["mature", "all"],
    badge: "Premium",
    description: "Advanced peptide complex for firmer, more youthful-looking skin",
  },
  {
    id: 12,
    name: "Glycolic Acid Exfoliant",
    price: 34.99,
    image: "/glycolic-acid-exfoliant.jpg",
    rating: 4.5,
    reviews: 88,
    category: "treatments",
    skinType: ["oily", "combination"],
    badge: null,
    description: "Professional-strength glycolic acid for smooth, radiant skin",
  },
  {
    id: 13,
