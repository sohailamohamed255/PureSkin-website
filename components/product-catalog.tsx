...
const allProducts = [
  ...
  },
  {
    ...
    skinType: ["all", "dry"],
    badge: null,
    description: "Refreshing mist that hydrates and preps skin for skincare",
  },
  {
    id: 6,
    ...
    skinType: ["mature", "all"],
    badge: "Premium",
    description: "Advanced retinol formula for youthful, radiant skin",
  },
  {
    id: 7,
    ...
    badge: "Best Seller",
    description: "Natural exfoliating scrub for smoother, brighter complexion",
  },
  {
    id: 8,
    ...
    skinType: ["dry", "mature"],
    badge: "New",
    description: "Luxurious oil blend that deeply nourishes and revitalizes",
  },
  {
    id: 9,
    name: "Daily Sunscreen SPF 50",
    price: 34.99,
    image: "/sunscreen-spf50-daily.jpg",
    rating: 4.7,
    reviews: 201,
    category: "treatments",
    skinType: ["all"],
  ...
  },
  {
    ...
    price: 39.99,
    image: "/hydrating-face-mask.jpg",
    rating: 4.6,
    reviews: 134,
    category: "treatments",
    skinType: ["dry", "sensitive"],
    badge: null,
    description: "Intensive moisture treatment for instant hydration boost",
  },
  {
    id: 11,
    name: "Brightening Essence",
    price: 42.99,
    image: "/brightening-essence.jpg",
    rating: 4.8,
    reviews: 95,
    category: "serums",
    skinType: ["all", "combination"],
    badge: null,
    description: "Lightweight essence that illuminates and evens skin tone",
  },
  {
    id: 12,
    name: "Lip Treatment Balm",
    price: 18.99,
    image: "/lip-treatment-balm.jpg",
    rating: 4.5,
    reviews: 78,
    category: "treatments",
    skinType: ["all"],
    badge: null,
    description: "Nourishing balm that soothes and repairs dry, chapped lips",
  },
]
