...
const allProducts = [
  ...
  },
  {
    ...
    skinType: ["mature", "all"],
    badge: "Premium",
    description: "Advanced anti-aging serum for nighttime use",
  },
  {
    id: 10,
    ...
    skinType: ["all", "sensitive"],
    badge: null,
    description: "Mild cleanser that removes makeup and impurities",
  },
  {
    id: 11,
    ...
    skinType: ["mature", "all"],
    badge: "Luxury",
    description: "Rich eye cream for reducing fine lines and puffiness",
  },
  {
    id: 12,
